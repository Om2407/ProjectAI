  ...
  const projects = [
    {
      ...
      description: "A comprehensive Learning Management System powered by AI with features like course management, video streaming, payment integration, and intelligent recommendations using Google Gemini API.",
      image: "/project1.png",
      tech: ["MERN Stack", "Three.js", "Google Gemini API", "Cloudinary", "Razorpay", "JWT", "Redux Toolkit", "OAuth 2.0"],
      stars: 456,
      category: "Full Stack Web App",
      liveDemo: "#",
      sourceCode: "https://github.com/Om2407/AI-LMS-WEBSITE.git"
    },
    {
      id: 2,
      title: "AI Website Builder",
      description: "A SaaS application that builds websites using AI. Generate stunning websites with AI-powered design suggestions, image integration from Pexels API, and real-time preview.",
      image: "/project2.png",
      tech: ["React", "Vite", "Google Gemini API", "Pexels API", "Tailwind CSS"],
      stars: 342,
      category: "SaaS Application",
      liveDemo: "#",
      sourceCode: "https://github.com/Om2407/ProjectAI.git"
    },
    {
      id: 3,
      title: "Remote Interview Platform",
      description: "A modern remote interview platform with real-time video calls, authentication, and automated workflows. Features include live coding environment and interview scheduling.",
      image: "/project3.png",
      tech: ["MERN Stack", "Clerk Auth", "GetStream", "Inngest", "RESTful API"],
      stars: 289,
      category: "Interview Platform",
      liveDemo: "#",
      sourceCode: "https://github.com/Om2407/Interview-Platform.git"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto mb-8">
            Discover innovative full-stack applications powered by AI and modern web technologies. Built with passion and cutting-edge tools.
          </p>
          <a
